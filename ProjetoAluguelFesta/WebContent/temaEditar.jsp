			...
			<form class="form-inline my-2 my-lg-0 mr-lg-2" action="salvarTema"
				...
				<table>
					...
					<tr>
						...
						<td><input class="form-control" type="text" name="valor"
							id="valor" value="${tem.valor}" size="50" maxlength="100"></td>
					</tr>
					<tr>
						<td><label for="corDaToalha">Cor da toalha:</label></td>
						<td><input class="form-control" type="text"
							name="corDaToalha" id="corDaToalha" value="${tem.corDaToalha}"
							size="50" maxlength="100"></td>
					</tr>
					<tr>
						<td><label for="nome">Nome:</label></td>
						<td><input class="form-control" type="text" name="nome"
							id="nome" value="${tem.nome}" size="50" maxlength="100"></td>
					</tr>
					<tr>
						<td></td>
						<td>
